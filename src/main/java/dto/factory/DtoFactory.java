...
public abstract class DtoFactory <I, O>{
    protected final DataBaseService dataBaseService = DataBaseService.of();
    protected final ApiResponse FAIL_API_RESPONSE = new ApiResponse(HttpServletResponse.SC_BAD_REQUEST, "Что-то пошло не так. Проверьте введенные данные."); ;
    protected final ApiResponse OK_API_RESPONSE = new ApiResponse(HttpServletResponse.SC_OK, "Все прошло успешно.");;
